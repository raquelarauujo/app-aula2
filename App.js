...
const Layout = () => {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      {[
        { name: 'Joy Division', year: 'Reino Unido - 1976', uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ17jy0JZsiBcIlMju-b7ePb5d3uaFTmlYsHw&s' },
        { name: 'Bauhaus', year: 'Reino Unido - 1978', uri: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Bauhaus-Signet.svg/2168px-Bauhaus-Signet.svg.png' },
        { name: 'Siouxsie And The Banshees', year: 'Reino Unido - 1978', uri: 'https://www.studsandspikes.com/media/catalog/product/cache/ac0a2306909b95a5b7078e2821ec5639/9/p/9pts22siou04_design.jpg' },
        { name: 'Echo & The Bunnyman', year: 'Reino Unido - 1978', uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTKY-O4WKDtCLWUZv-aJnGHtxUXi6Padm8fA&s' },
        { name: 'The Cure', year: 'Reino Unido - 1976', uri: 'https://m.media-amazon.com/images/I/51iMLO+s3RL._AC_UY1100_.jpg' },
      ].map((band, index) => (
      ...
      {[
        { name: 'Sex Pistols', year: 'Reino Unido - 1975', uri: 'https://cdn.displate.com/artwork/270x380/2024-12-05/7e7dd7ed-430c-4515-8a03-42355eae6b58.jpg' },
        { name: 'Ramones', year: 'Estados Unidos - 1974', uri: 'https://www.deadrockers.net/cdn/shop/products/s6079_360x_1_2048x.webp?v=1647579053' },
        { name: 'Dead Kennedys', year: 'Estados Unidos - 1978', uri: 'https://i.pinimg.com/736x/4b/78/c5/4b78c58fe4b97dd72de8ada215ee468d.jpg' },
        { name: 'Misfits', year: 'Estados Unidos - 1977', uri: 'https://i.scdn.co/image/ab67616100005174030d67ff9576754ff230b2c0' },
        { name: 'Descendents', year: 'Estados Unidos - 1978', uri: 'https://images.sk-static.com/images/media/profile_images/artists/277581/huge_avatar' },
      ].map((band, index) => (
        <View key={index} style={styles.boxLista}>
          <Image source={{ uri: band.uri }} style={styles.imageLista} />
          <View style={styles.textContainer}>
...
{[
  { name: 'Chico Buarque', year: '19 de Junho de 1944 - Rio de Janeiro', uri: 'https://i.scdn.co/image/ab67616d0000b273175c5e58d396b45c4f637deb' },
  { name: 'Jorge Ben Jor', year: '22 de Março de 1939 - Rio de Janeiro', uri: 'https://novabrasilfm.com.br/app/uploads/2024/03/jorge_ben_jor_-_divulgacao_a-768x715.webp' },
  { name: 'Maria Bethânia', year: '18 de Junho de 1946 - Bahia', uri: 'https://akamai.sscdn.co/uploadfile/letras/fotos/f/d/f/7/fdf711ba6112c3dddd11dcbb4666e30a.jpg' },
  { name: 'Gal Costa', year: '26 de Novembro de 1945 - Bahia', uri: 'https://fringe.com.br/wp-content/uploads/2025/01/galcosta.jpg' },
  { name: 'Rita Lee', year: '31 de Dezembro de 1947 - São Paulo', uri: 'https://images.squarespace-cdn.com/content/v1/5d30ccca1094830001b9fdb7/3003a851-1d20-4382-bca5-ea5f168fbe97/00-+Capa+Rita3.jpg' },
].map((band, index) => (
  <View key={index} style={styles.boxLista}>
    <Image source={{ uri: band.uri }} style={styles.imageLista} />
    <View style={styles.textContainer}>
